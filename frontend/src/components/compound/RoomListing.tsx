...
import { RoomListingProps } from "../types";

//https://pbs.twimg.com/profile_images/1387824030602780673/CqiWzrma_400x400.jpg

export default function RoomListing({ RoomData }: RoomListingProps) {
  const stock_image = "";
  return (
    <>
      <div className="p-6 bg-[#FFFDF3] rounded-2xl flex flex-col gap-4 border-[1px] max-w-sm m-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex flex-col items-center max-w-[60%]">
            ...
            <span></span>
            <a
              href={RoomData.contact.twitter_url}
              className="text-blue-500 hover:text-blue-400 "
            >
              @{RoomData.contact.twitter_handle}
            </a>
